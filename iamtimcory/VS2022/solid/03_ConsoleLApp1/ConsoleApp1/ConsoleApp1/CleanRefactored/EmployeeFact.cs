...
using ConsoleApp1.Refactored.Interfaces;

namespace ConsoleApp1.Refactored
{
    public class EmployeeFact : IManagedEmployee
    {
        ...
        public EmployeeFact Manager { get; set; }
        ...
        public virtual void AssignManager(EmployeeFact manager)
        {
